...
export class CategoryComponent implements OnInit {
  ...
  categories : Category[];
  currentCategory:Category;  //"strictPropertyInitialization": false,  newlemedik yani bu yapıyı false yaparak interface in referansından yararlanıyoruz.Yararlamak istediğimiz için bunu fal se yaptık
